...
#### Voraussetzung 
  ...
  - Für den Make-Aufruf bestimmt und überschreibt der FirmwareReleaseBuilder die Umgebungsvariablen `GLUON_BRANCH`, `GLUON_RELEASE`, `GLUON_PRIORITY` und `GLUON_TARGET`. Dieses ist für die Gestaltung der zu verwendenden `site.mk` zu berücksichtigen.
